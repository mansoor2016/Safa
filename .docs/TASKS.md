...
| S | "Prayer ending soon" follow-up notification — schedule a second notification before prayer window closes (next prayer starts). Custom sounds (11 .caf), `.timeSensitive`, `relevanceScore=1.0`, Focus Mode categories, and wudhu reminders already shipped. |
