...
final class PrayerViewModelTests: XCTestCase {
    ...
    private var testWidgetSuiteName: String!
    ...
    override func setUp() {
        ...
        // Isolated WidgetDataService so reconciliation reads empty widget keys
        testWidgetSuiteName = "group.com.safa.app.test.vm.\(UUID().uuidString)"
        let testWidgetDataService = WidgetDataService(suiteName: testWidgetSuiteName)
    ...
    override func tearDown() {
        if let name = testWidgetSuiteName {
            UserDefaults(suiteName: name)?.removePersistentDomain(forName: name)
        }
        testWidgetSuiteName = nil
        sut = nil
